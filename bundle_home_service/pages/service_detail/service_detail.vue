...
export default {
    ...
    data() {
        return {
            ...
            certifications: [
                { name: '实名认证', icon: 'checkmark-circle' },
                { name: '健康证', icon: 'heart' },
                { name: '厨师证', icon: 'star' }
            ],
            experienceList: [
                { label: '做饭能力', content: '擅长煲汤、面食' },
                { label: '照顾小孩', content: '照顾幼儿, 接送小孩' },
                { label: '照顾老人', content: '照顾自理老人' },
                { label: '照顾宠物', content: '照顾猫、照顾狗' },
                { label: '其他技能', content: '会配营养餐、会开车' }
            ],
            intentionList: [
                { label: '工作类型', content: '保姆月嫂' },
                { label: '服务内容', content: '照顾老人' }
            ],
            storeInfo: {
                name: '西百花巷16号3D打印别墅',
