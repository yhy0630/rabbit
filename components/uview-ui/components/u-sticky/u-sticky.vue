	...
	export default {
		...
		methods: {
			initObserver() {
				...
				const stickyTop = typeof this.offsetTop == 'string' ? parseInt(this.offsetTop) : uni.upx2px(this.offsetTop)
				// #ifdef H5
				this.stickyTop = this.offsetTop != 0 ? stickyTop + this.h5NavHeight : this.h5NavHeight;
				// #endif
				// #ifndef H5
				this.stickyTop = this.offsetTop != 0 ? stickyTop : 0;
				// #endif
