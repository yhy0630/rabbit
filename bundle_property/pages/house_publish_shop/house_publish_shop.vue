    ...
    <view class="publish-page">
        ...
        <view class="header-navbar">
            <view class="navbar-content">
                ...
                <view class="navbar-title">发布商铺</view>
        ...
        <scroll-view class="content-scroll" scroll-y>
            <PropertyPublishCommercial
                ...
                page-title="发布商铺"
                title-label="商铺标题"
                description-label="商铺描述"
                description-placeholder="请简单介绍商铺优势、适合业态、周边人流等信息"
                image-subtitle="房源图片（最多15张，每张小于2M）"
                category-code="shop_office"
                :show-floor="true"
                :show-area="true"
