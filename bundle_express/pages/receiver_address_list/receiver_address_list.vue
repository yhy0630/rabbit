<template>
  <view class="address-list-page">
    <view class="no-address" v-if="!hasAddress">
      ...
      <view class="empty-text">暂无收件地址，请添加~</view>
    </view>
    ...
    <view class="footer-bar">
      <button class="add-btn" @click="addAddress">新增收件地址</button>
    </view>
  </view>
</template>
...
export default {
  ...
  onLoad(options) {
    this.addressType = options.type || 'receiver';
  ...
  methods: {
    ...
    selectAddress(item) {
      // 发送地址选择事件
      uni.$emit('selectReceiverAddress', item);
      uni.navigateBack();
    },
    setDefault(id) {
